...
public class FunctionAPI {
	...
	/*
	I will using treemap for store data, so it will order ascending and for better latency purpose
	Source : 
	...
	*/
	...
	public static Boolean check_blacklist(String name, int phone_number){
		...
		//or we can using Search Algorithm for Sorted Data if this method doesn't enough fast for each API Call
	}
}
